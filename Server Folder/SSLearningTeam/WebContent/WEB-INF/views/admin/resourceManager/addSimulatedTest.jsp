						...
						<div class="card card-info collapsed-card card-outline">
							...
							<div class="card-body">
								<div class="tab-pane" id="timeline">
									<form action="${pageContext.request.contextPath }/train/admin/addSimulatedTest" method="POST" enctype="multipart/form-data">
											请选择语言类别：
										...
										<br/>请设置课程名称：<input type="text" name="testName"/>
