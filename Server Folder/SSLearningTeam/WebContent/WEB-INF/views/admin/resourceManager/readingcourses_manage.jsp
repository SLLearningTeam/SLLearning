...
<script>
	function toAddReadingCourse(){
		location.href="${pageContext.request.contextPath}/course/admin/toAddReadingCourse";
	}
</script>
				...
				<div class="col-xs col-sm col-md">
					<div class="card ">
						<div class="card-header p-2 ">
							...
							<input type="button" class="btn btn-warning" style="margin-right:50px" value="添加课程" onclick="toAddReadingCourse()"/>
								<li class="nav-item">
								...
								<li class="nav-item">
										<a class="nav-link active" href="${pageContext.request.contextPath}/course/admin/readingCourses_manage/1">
										阅读课程列表
									</a>
								</li>
								<li class="nav-item">
										...
										<table class="table table-hover table-bordered ">
											...
											<c:forEach var="readingcourse" items="${courses.readingCourses}" varStatus="status">
												<tr style="text-align: center">
													...
													<td><a href="javascript:void(0)" onclick="showAddCourseQuestion('readingcourse',${readingcourse.courseId},this)" class="btn btn-success">添加问题</a></td>
													<td><a href="javascript:void(0)" onclick="showAllCourseQuestion('readingcourse',${readingcourse.courseId},this)" class="btn btn-primary">查看问题</a></td>
