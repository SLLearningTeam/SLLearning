...
<head>
  ...
  <title>听说在线学习平台 | 管理端  课程详情页</title>
      ...
      <div class="container-fluid">
        ...
        <div class="card">
              <div class="card-header ">
                ...
                <h3 class="card-title"><img alt="" src="./img/resource/course.png">课程详情</h3>
              </div>
              <!--课程详情列表 -->
              <div class="card-body">
                <table class="table table-bordered">
                  <tr style="text-align: center;color: #b101ae">
                    <th>#</th>
                    <th>课程名称</th>
                    <th>语言类型</th>
                    <th>类别类型</th>
                  ...
                  <tr style="text-align: center">
                    ...
                    <td><span class="badge bg-info">1901</span></td>
                    <td>1</td>
                    <td>好</td>
                     <td>
                    <img alt="" src="./img/resource/update.png" width="23px" height="23px"> 
                    <td>
                    <img alt="" src="./img/resource/delete.png" width="20px" height="20px">
                    </td>
                  </tr>
                </table>
              </div>
