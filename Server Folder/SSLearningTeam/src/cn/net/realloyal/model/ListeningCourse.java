...
public class ListeningCourse extends Course{
	...
	public String toString() {
		return "ListeningCourse [courseId=" + courseId + ", languageType=" + languageType + ", rateType=" + rateType
	...
	public ListeningCourse(int courseId, LanguageType languageType, RateType rateType, String courseName,
