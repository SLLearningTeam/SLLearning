    ...
    componentDidMount() {
        fetch('http://101.200.51.53:8080/SSLearningTeam/course/user/courses_manage/1')
            ...
            .then((responseJson) => {
                this.setState({
                    loaded: true,
                    title : responseJson.info.courses.listeningCourses[4].courseName,
                    jianjie : responseJson.info.courses.listeningCourses[4].courseChineseContent,
                    details : responseJson.info.courses.listeningCourses[4].courseEnglishContent,
                    Num : responseJson.info.courses.listeningCourses[4].downloadNum,
                });
