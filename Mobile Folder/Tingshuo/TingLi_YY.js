        ...
        fetch('http://101.200.51.53:8080/SSLearningTeam/course/user/courses_manage/1')
            ...
            .then((responseJson) => {
                this.setState({
                    ...
                    jianjie : responseJson.info.courses.listeningCourses[0].courseChineseContent,
                    details : responseJson.info.courses.listeningCourses[0].courseEnglishContent,
                    Num : responseJson.info.courses.listeningCourses[0].downloadNum,
                });
