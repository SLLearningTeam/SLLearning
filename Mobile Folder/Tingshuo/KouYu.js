...
export default class ShiTi extends Component<Props> {
  render() {
    ...
    <ScrollView  horizontal = {false}
     ...
     <Text style={styles.biaoTi}>待显示简介口语内容</Text>
     ...
     <View>
     <TouchableOpacity onPress={this.kouyu.bind(this)} >
     <Image style={{ width:60,height:60,marginLeft:175,marginTop:10 }} source={require('../imgs/kouyu.png')}/>
     </TouchableOpacity>
     </View> 
