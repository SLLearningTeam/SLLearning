...
<script>
	function toAddListeningCourse(){
		location.href="${pageContext.request.contextPath}/course/admin/toAddListeningCourse";
	}
</script>
				...
				<div class="col-xs col-sm col-md">
					<div class="card ">
						<div class="card-header p-2 ">
							...
							<input type="button" class="btn btn-warning" style="margin-right:50px" value="添加课程" onclick="toAddListeningCourse()"/>
								<li class="nav-item">
								...
								<li class="nav-item">
										<a class="nav-link active" href="${pageContext.request.contextPath}/course/admin/listeningCourses_manage/1">
										听力课程列表
									</a>
								</li>
								<li class="nav-item">
